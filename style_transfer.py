...
def check_scipy():
    import scipy
    vnum = int(scipy.__version__.split('.')[0])
...
def gram_matrix(features, normalize=True):
    ...
    # gamma = tf.transpose(features_reshape,[1,0]) @ features_reshape
...
def tv_loss_test(correct):
    ...
    error = rel_error(correct, student_output)
    print('Total loss Error is {:.3f}'.format(error))
...
def style_transfer(content_image, style_image, image_size, style_size, content_layer, content_weight,
    ...
    for t in range(max_iter+1):
        ...
        if t % 100 == 0:
            ...
            plt.title('Generated Image at Iteration {}'.format(t))
            plt.axis('off')
            #plt.show()
    plt.show()
    #print('Iteration {}'.format(t))
...
params3= {
    'content_image' : 'styles/content1.jpg',
    'style_image' : 'styles/style1.jpg',
    'image_size' : 192,
    'style_size' : 512,
    'content_layer' : 3,
    'content_weight' : 5e-2, 
