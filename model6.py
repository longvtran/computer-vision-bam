...
def ConvNet(num_classes_media=7, num_classes_emotion=4, training=False):
    ...
    x_media = tf.keras.layers.Dense(units=128, 
                                    kernel_regularizer=tf.keras.regularizers.l2(1e-3),
                                    activation='relu')(x_media)
    ...
    x_emotion = tf.keras.layers.Dense(units=128, 
                                      kernel_regularizer=tf.keras.regularizers.l2(1e-3),
                                      activation='relu')(x_emotion)
    x_emotion = tf.keras.layers.Dropout(rate=0.9)(x_emotion)
