...
def ConvNet(num_classes_media=7, num_classes_emotion=4, training=False):
    ...
    x_media = tf.keras.layers.Dense(units=64, kernel_regularizer=tf.keras.regularizers.l2(1e-3))(x_media)
    ...
    x_emotion = tf.keras.layers.Dense(units=64, kernel_regularizer=tf.keras.regularizers.l2(1e-3))(x_emotion)
